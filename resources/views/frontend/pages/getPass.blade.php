...
>
  <head>
    ...
    <title>Techchain | Lấy lại mật khẩu</title>
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2 text-center">Nhập mật khẩu của bạn</h4>
              <form id="formAuthentication" class="mb-3" method="POST">
                @csrf
                <input type="hidden" name="id" value="43">
                <div class="mb-3 form-password-toggle me-1">
                    <div class="d-flex justify-content-between">
                        <label class="form-label" for="npassword">Mật khẩu mới</label>
                    </div>
                ...
                <div class="mb-3 form-password-toggle me-1">
                    <div class="d-flex justify-content-between">
                        <label class="form-label" for="cfpassword">Nhập lại mật khẩu</label>
                    </div>
                    <div class="input-group input-group-merge">
                ...
                <button class="btn btn-primary d-grid w-100">Lấy lại mật khẩu</button>
              </form>
            </div>
          </div>
          <!-- /Forgot Password -->
