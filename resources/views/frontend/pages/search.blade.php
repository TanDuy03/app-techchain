        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Tìm kiếm</h1> 
                        <nav aria-label="breadcrumb animated fadeIn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                            <li class="breadcrumb-item text-body active" aria-current="page">Tìm kiếm</li>
                        </ol>
                    </nav>
                </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="alert alert-warning">
                <span class="d-block">Đã tìm thấy {{count($listt)}} tin</span>
            </div>
                    ...
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 185, 142, .3)">
                        <div class="row g-5 align-items-center">
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                <img class="img-fluid rounded w-100" src="{{ $row->urlHinh }}" alt=""
                            ...
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                                ...
                                <a href="/chi-tiet/{{ $row->id }}" class="btn btn-primary py-3 px-4 me-2">
