...
>
  <head>
    ...
    <title>Techchain | Xác thực email</title>
  ...
  <body>
    ...
    <div class="container-xxl">
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner py-4" style="width: 420px !important;">
          <!-- Forgot Password -->
          <div class="card">
            <div class="card-body">
              <!-- Logo -->
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text fs-2 text-body fw-bolder">Techchain</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <p class="mb-4">Vui lòng nhấn nút xác thực trong hòm thư.</p>
              <form id="formAuthentication" class="mb-3" action="{{route('verification.send')}}" method="POST">
                @csrf
                <button class="btn btn-primary w-100">Gửi lại Email <i class='bx bx-send'></i></button>
              </form>
            </div>
          </div>
          <!-- /Forgot Password -->
    ...
    <div class="buy-now">
        @if (session('success'))
            <div class="btn-buy-now alert alert-success text-white py-3">
                {{ session('success') }} <i class='bx bx-badge-check'></i>
            </div>
        @elseif(session('danger'))
            <div class="btn-buy-now alert alert-danger text-white py-3">
                {{ session('danger') }} <i class="fas fa-exclamation-triangle"></i>
            </div>
        @elseif(session('info'))
            <div class="btn-buy-now alert alert-info text-white py-3">
