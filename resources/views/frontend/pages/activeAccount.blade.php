...
>
  <head>
    ...
    <title>Kích hoạt tài khoản | Techchain</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text fs-3 text-body fw-bolder">Techchain</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Kích hoạt tài khoản</h4>
              <div class="d-flex">
                <p class="mb-4">Cho chúng tôi biết địa chỉ email mà bạn muốn kích hoạt</p>
                 <i class='bx bx-lock-open-alt'></i>
              </div>
              <form id="formAuthentication" class="mb-3" action="{{route('active.post')}}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <button class="btn btn-primary d-grid w-100">Kích hoạt</button>
              </form>
