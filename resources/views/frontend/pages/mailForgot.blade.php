<div style="width: 800px; margin: 10px auto;">
    <div style="width: 100%;">
        <h5 style="text-align: center; font-size: 1.3rem; margin-bottom: 10px; color: #0c0c0c;">Chúc 
            <span style="color: #ff0000;">{{$data->ten}}</span> ngày mới tốt lành!</h5>
    ...
    <div style="width: 100%; margin: auto;">
        <a href="{{route('getpass', ['id'=>$data->id_user, 'token'=>$data->remember_token])}}"  style="width: 200px; height: 40px;
        ...
        border-radius: 8px;">Click tại đây</a>
    </div>
</div>