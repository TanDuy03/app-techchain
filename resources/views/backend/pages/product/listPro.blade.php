...
@section('content')
    ...
    <div class="card">
        <div class="d-flex justify-content-between">
            ...
            <div class="p-3">
                <a href="{{route('product.create')}}" class="btn btn-success">Tạo mới &nbsp;<i class="bi bi-plus-circle"></i></a>
            </div>
        </div>
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="img__container_admin mx-auto">
                                        <img onerror="this.src='/upload/img_error.jpg'" src="{{asset($item->hinh)}}" class="img__list_admin" alt="">
                                    </div>
                                </td>
                                <td>{{ucfirst($item->ten_sp)}}</td>
                                ...
                                <td class="text-center">
                                    <div>
                                        ...
                                        <a class="btn btn-primary btn-sm mx-1" href="{{url('admin/product/'.$item->id_sp.'/edit')}}"><i class="fas fa-edit"></i></a>
                                        <form class="d-inline" action="{{route('product.destroy', $item->id_sp)}}" method="POST">
                                            @csrf  @method('DELETE')
