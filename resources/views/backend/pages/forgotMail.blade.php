...
>
  <head>
    ...
    <title>Quên mật khẩu | Techchain</title>
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Lấy lại mật khẩu? 🔒</h4>
              <p class="mb-4">Nhập email mà bạn đăng đăng ký với chúng tôi!</p>
              <form id="formAuthentication" class="mb-3" action="{{route('forgot.pass')}}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <button class="btn btn-primary d-grid w-100">Gửi mail</button>
              </form>
